...
def get_national_id(number_files , file_name):
    if number_files == 1 :
        national_image = rf'C:\Users\yassi\Desktop\my_ocr\runs\detect\predict\crops\national_id'+ '\\'  + file_name
    else:
         national_image = rf'C:\Users\yassi\Desktop\my_ocr\runs\detect\predict{number_files+1}\crops\national_id'+ '\\'  + file_name
...
def get_segements(source , number_files):
    ...
    def get_images():
        ...
        for name in image_names:
            img_file = rf'C:\Users\yassi\Desktop\my_ocr\runs\detect\predict{number_files+1}\crops\{name}'+ '\\'  + file_name
